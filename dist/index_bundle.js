...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(2),
	      ...
	      Main = __webpack_require__(229),
	      Home = __webpack_require__(241),
	      PromptContainer = __webpack_require__(244),
	      ConfirmBattleComponent = __webpack_require__(246);
	ResultsContainer = __webpack_require__(270);
	...
	const routes = React.createElement(
	  ...
	  React.createElement(
	    ...
	    React.createElement(Route, { path: 'battle', component: ConfirmBattleComponent }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	const ReactCSSTransitionGroup = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	transparentBg = __webpack_require__(242).transparentBg, Jumbotron = __webpack_require__(243);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Jumbotron = props => React.createElement(
	  'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(2),
	      Prompt = __webpack_require__(245);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(2),
	      ...
	      Jumbotron = __webpack_require__(243);

	const Prompt = props => React.createElement(
	  Jumbotron,
	  null,
	  React.createElement(
	    'h1',
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(2),
	      PropTypes = React.PropTypes,
	      ConfirmBattle = __webpack_require__(247),
	      githubHelpers = __webpack_require__(251);

	const ConfirmBattleComponent = React.createClass({
	  displayName: 'ConfirmBattleComponent',
	  ...
	  componentDidMount() {
	    ...
	    githubHelpers.getPlayersInfo([query.playerOne, query.playerTwo]).then(githubData => {
	      if (!githubData) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(2),
	      styles = __webpack_require__(242),
	      Link = __webpack_require__(168).Link,
	      PlayerDetailsWrapper = __webpack_require__(248),
	      UserDetails = __webpack_require__(249),
	      Jumbotron = __webpack_require__(243),
	      Loading = __webpack_require__(250);

	const ConfirmBattle = props => {

	  playerDetails = props.playersInfo.map((playerInfo, idx) => React.createElement(
	    UserDetailsWrapper,
	    { key: idx, header: `Player ${ idx + 1 }` },
	    React.createElement(UserDetails, { key: idx, info: playerInfo })
	  ));
	  // Check to see isLoading status
	  return props.isLoading === true ? React.createElement(
	    Jumbotron,
	    null,
	    React.createElement(Loading, { text: 'Waiting' })
	  ) : React.createElement(
	    Jumbotron,
	    {
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { style: styles.space, type: 'button', className: 'btn btn-lg btn-success', onClick: props.onStartBattle },
	          'Initiate Battle!'
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { style: styles.space, type: 'button', className: 'btn btn-lg btn-danger' },
	            'Reselect Players'
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	UserDetailsWrapper = props => React.createElement(
	  'div',
	  { className: 'col-sm-6' },
	  React.createElement(
	    'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	UserDetails = user => React.createElement(
	  'div',
	  null,
	  ...
	  React.createElement(
	    'li',
	    { className: 'list-group-item' },
	    React.createElement('img', { style: styles.profileImg, src: user.info.avatar_url, className: 'img-rounded img-responsive' })
	  ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	const axios = __webpack_require__(252);
	...
	const getPlayerData = player => {
	  return getRepos(player.login).then(repos => {
	    return {
	...
	const helpers = {
	  ...
	  battle(playersInfo) {
	    ...
	    return axios.all([getPlayerData(playersInfo[0]), getPlayerData(playersInfo[1])]).then(calculateTotalScores).catch(err => {
	      console.log("There was an error in the battle process", err);
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(2),
	      Results = __webpack_require__(271),
	      githubHelpers = __webpack_require__(251);
	...
	const ResultsContainer = React.createClass({
	  ...
	  componentDidMount() {
	    ...
	    githubHelpers.battle(this.props.location.state.playersInfo).then(results => {
	      this.setState({
	        scores: results,
	        isLoading: false
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(2),
	      PropTypes = React.PropTypes,
	      styles = __webpack_require__(242),
	      UserDetailsWrapper = __webpack_require__(248),
	      UserDetails = __webpack_require__(249),
	      Link = __webpack_require__(168).Link,
	      Jumbotron = __webpack_require__(243),
	      Loading = __webpack_require__(250);
	...
	const StartOver = () => React.createElement(
	  'div',
	  { className: 'col-sm-12' },
	  React.createElement(
	    Link,
	...
	const Results = props => {
	  if (props.isLoading === true) {
	    return React.createElement(
	      Jumbotron,
	      null,
	      React.createElement(Loading, { text: 'Just a sec' })
	    );
	  }
	  // Check first for tie
	  ...
	  return props.isLoading === true ? React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        UserDetailsWrapper,
	        { header: 'Winner' },
	        React.createElement(UserDetails, { score: props.scores[winnerIdx], info: props.playersInfo[winnerIdx] })
	      ),
	      React.createElement(
	        UserDetailsWrapper,
	        { header: 'Loser' },
	        React.createElement(UserDetails, { score: props.scores[loserIdx], info: props.playersInfo[loserIdx] })
	      )
	    ),
	    React.createElement(StartOver, null)
	  );
